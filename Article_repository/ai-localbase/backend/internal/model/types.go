...
type ServerConfig struct {
	...
	SparseEncoderURL               string
	SparseEncoderModel             string
	SparseEncoderAPIKey            string
	EnableHybridSearch             bool
	EnableSparseQueryTranslation   bool
	EnableQueryTranslation         bool
	QueryTranslationMode           string
	QueryTranslationProvider       string
	QueryTranslationBaseURL        string
	QueryTranslationAPIKey         string
	QueryTranslationModel          string
	QueryTranslationTimeoutSeconds int
...
type RetrievalDebugResponse struct {
	...
	QueryTranslation string                        `json:"queryTranslation,omitempty"`
	KnowledgeBaseID  string                        `json:"knowledgeBaseId,omitempty"`
	DocumentID       string                        `json:"documentId,omitempty"`
	SearchMode       string                        `json:"searchMode"`
	RerankStrategy   string                        `json:"rerankStrategy"`
